...
/**
 * Created by arcearta on 2016/08/03.
 */
...
public class SimpleCredentialProvider extends CredentialProvider {
    ...
    public static final String SECRET = "hE9LKFw5HzRMtoU4a14ulzws";
    public static final String CLIENT_ID = "401881601919-omjth38md0au6gbtoo3pgrv57ja5lal2.apps.googleusercontent.com";


    private static final String TAG = SimpleCredentialProvider.class.getSimpleName();
     ...
     */
    public SimpleCredentialProvider(OkHttpClient client, String refreshToken)
     ...
     * @throws LoginFailedException When login fails
     */
    public SimpleCredentialProvider(OkHttpClient client,
